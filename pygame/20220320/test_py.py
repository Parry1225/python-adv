...
mp3_path = 'pygame/20220320/snow-dream (1).mp3'
...
while True:
    ...
    if act:
        now_speed = rain_speed
        title = font.render('stop', True, (0, 0, 0))
        pygame.mixer.music.pause()
        for rain in rain_lint:  # x_site2, y_site2, r_width, r_length, x_shift2, y_shift2
