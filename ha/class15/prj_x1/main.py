...
def on_massage(topic, msg):
    global msg_json, distance, open_door, msg_xx
...
mcu.mqtt_subscribe(mq_id_input='Singular_is_fake', on_massage=on_massage)
...
while True:
    mcu.mqtt_get_msg(topic_input="Singular_is_fake")
    mcu.mqClient0.ping()
    vipx2 = adc.read()
    d.measure()
    temp = d.temperature()
